...
module.exports = function(push, pushdev, channelRouter) {
  ...
  db.run(r
    ...
    , 'platform'
    , 'platformFamily'
    , {ios: ['udid', 'name', 'productType', 'productVersion', 'simulator', 'transport']}
    )
  ...
  .then(function(cursor) {
    cursor.each(function(err, data) {
      ...
      if (data.old_val === null) {
        ...
        data.new_val.platform !== data.old_val.platform ||
        data.new_val.platformFamily !== data.old_val.platformFamily ||
        data.new_val.group.origin !== data.old_val.group.origin ||
        data.new_val.operator !== data.old_val.operator ||
        !_.isEqual(data.new_val.ios || null, data.old_val.ios || null) ||
